			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="<?= $current_page == 'pc_gamer' ? 'active-menu' : ''; ?>">
								<a href="<?= base_url(); ?>">Inicio</a>
							</li>

							<li class="<?= $current_page == 'tienda' ? 'active-menu' : ''; ?>">
								<a href="<?= base_url(); ?>/tienda">Tienda</a>
							</li>
							<li class="<?= $current_page == 'carrito' ? 'active-menu' : ''; ?>">
								<a href="<?= base_url(); ?>/carrito">Carrito</a>
							</li>
							<li class="<?= $current_page == 'nosotros' ? 'active-menu' : ''; ?>">
								<a href="<?= base_url(); ?>/nosotros">Nosotros</a>
							</li>
							<li class="<?= $current_page == 'sucursales' ? 'active-menu' : ''; ?>">
								<a href="<?= base_url(); ?>/sucursales">Sucursales</a>
							</li>
							<li class="<?= $current_page == 'contacto' ? 'active-menu' : ''; ?>">
